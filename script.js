...
const API = "http://10.106.208.22:3000/api/jogos";
...
randomBtn.addEventListener("click", jogosAleatorio);


// quando clicar no botão "Buscar"
searchBtn.addEventListener("click", buscarPorJogos);


// quando clicar na imagem do cachorro
// carrega outro cachorro aleatório
gameImage.addEventListener("click", jogosAleatorio);
